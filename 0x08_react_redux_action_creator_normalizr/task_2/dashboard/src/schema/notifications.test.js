...
describe("Normalized Notifications Data", () => {
  it("should return the correct result array of notification IDs", () => {
    ...
    const resultArray = normalizedNotifications.result;
    expect(resultArray).toEqual(expect.arrayContaining(expectedResultArray));
  });

  it("should return the correct user entity for userId 5debd764a7c57c7839d722e9", () => {
    const expectedUser = {
      age: 25,
  ...
  it("should return the correct message entity for guid efb6c485-00f7-4fdf-97cc-5e12d14d6c41", () => {
  ...
  it("should return the correct notification entity for id 5debd7642e815cd350407777", () => {
